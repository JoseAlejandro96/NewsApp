...
import com.star.project.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
            ...
            when(response){
                ...
                is Resource.Error -> {
                    ...
                    response.message?.let {message ->
                        Toast.makeText(requireContext(), "An error ocurred: $message", Toast.LENGTH_SHORT).show()
